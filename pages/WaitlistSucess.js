        ...
        <div className={styles.succesContainer}>
            ...
            <section className={styles.subheadersection}>
                ...
                <div className={styles.success__msg__container}>
                    ...
                    <p>1. Join the KreateSell Telegram channel - <a href='https://t.me/UseKreateSell'>Click here</a></p>
                    <p>2. Join KreateSell’s Facebook Group - <a href='https://www.facebook.com/groups/1143014409782318/'>Click here</a></p>
                    <p>3. <button onClick={()=> onButtonClick()} style={{color:'#0072ef'}}>Click here</button> to save KreateSell’s contact to your address book</p>
                </div>
