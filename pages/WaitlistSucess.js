            ...
            <section className={styles.subheadersection}>
                ...
                <div className={styles.success__msg__container}>
                    ...
                    <div className={styles.button__contain}>
                        <div className={styles.btn_tel}><a href="https://t.me/UseKreateSell">Join the Kreatesell Telegram channel</a></div>
                        <div className={styles.btn_fb}><a href="https://www.facebook.com/groups/1143014409782318/">Join the Kreatesell Facebook group</a></div>
                    </div>
                    {/* <p>
