        ...
        <div className={styles.body}>
            ...
            <div className={styles.groupQuestions}>
              ...
              <div className={styles.dropDown}>
                ...
                >
                  ...
                  >
                    <p className={styles.questions}>
                      I don&#39;t have foreign payment account, can i still
                      receive my payment?
                    </p>
                  </Link>
          ...
          <div className={styles.faqQuestionsCont}>
            ...
            <div className={styles.answerCont}>
              ...
              <div className={styles.answer} id="What-is-KreateSell">
                ...
                <p>
                  ...
                  foreign money collection issue. This isn&#39;t a barrier
                  anymore because prospects can now pay in the currency that is
            ...
            >
              ...
              <div className={styles.answer}>
                <p>
                  If you can&#39;t find an answer to the question you are having
                  or you have any complaint to log to the support. That
                  shouldn&#39;t be. We&#39;re sorry you are facing this. Kindly
                  send your complaint or question to{" "}
                  <a
                    target="blank"
            ...
            <div className={styles.answerCont} id="afraid-of-piracy">
              ...
              <div className={styles.answer}>
                <p>
                  Your products are safe on our platform, You don&#39;t need to
                  be scared of plagiarism because we don&#39;t give room to such
                  on this platform.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className={styles.answer}>
                <p>
                  ...
                  creators&#39; products on social media or your personal
                  websites to reach a massive market and bring in more sales,
                  also earn commision per sales made from the visitors you send
                  us through your affiliate link.
                </p>
              </div>
            </div>
            ...
            <div className={styles.answerCont} id="How-do-I-link-to-your-site">
              ...
              <div className={styles.answer}>
                <p>
                  ...
                  you&#39;ll be able to sign-in and see how to link to us.
                  It&#39;s very simple.
                </p>
              </div>
            </div>
            ...
            <div className={styles.answerCont} id="Do-I-need-to-pay-tax">
              ...
              <div className={styles.answer}>
                <p>
                  You&#39;ll need to reach out to your accountant if you don’t
                  know if and how to announce the earnings you receive from
                  KreateSell either as an entity or as an organization.
                  KreateSell doesn&#39;t outline any kind of tax related
                  guidelines, conference or services.
                </p>
              </div>
            </div>
            ...
            <div className={styles.answerCont} id="make-money-as-a-Creator">
              ...
              <div className={styles.answer}>
                <p>
                  ...
                  the knowledge you have into an ebook, video course, membership
            ...
            <div className={styles.answerCont} id="How-secure-is-KreateSell">
              ...
              <div className={styles.answer}>
                <p>
                  ...
                  unauthorized access of confidential credentials. We don&#39;t
                  take your credit card details on our platform. All the
                  payments are made and secured on verified and popularly
                  accepted Flutterwave.
                </p>
              </div>
            </div>
