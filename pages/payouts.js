...
const Payouts = () => {
	...
	const [feesCurrencyFlag, setFeesCurrencyFlag] =
		useState(currentFeesFlagObj);
			...
			<section className={styles.payoutsContainer}>
				<div className={styles.deskFlex}>
					<section>
						...
						<div className={styles.flagsAndText}>
							...
							<div
								className={`${styles.flagItems} ${styles.lgFlags}`}
							>
								<GenerateFlags
									data={data}
									withDetails={false}
							...
							<div className={styles.text}>
								...
								your default currency. So, you get to sell in
								any currency around the globe and have the
								amount converted and credited in your
				...
				<section className={styles.howPayoutsWork}>
					...
					<p className={styles.text}>
						We help you collect your payment from anywhere in the
						world, process and pay it in your local currency into
						your default account/ wallet. Processing time is
						dependent on your location and currency.
					</p>
				...
				<section className={styles.transactionFees}>
					<div className={styles.details}>
						...
						<p className={styles.text}>
							...
							countries and corresponding fees.
						</p>
					</div>
								...
								<div className={styles.top}>
									...
									<div className={styles.selectAndInput}>
										<Select
											placeholder="Select Currency"
											size="large"
											onChange={handleFeeCurrencySelect(
												'currency'
											)}
											value={feeCurrency}
											className={styles.selectContainer}
						...
						<div className={styles.txnBox}>
							...
							<div className={styles.percentBox}>
								...
								<p className={styles.subText}>
									of the sales price for <br /> your
									transaction fee.
								</p>
							</div>
						</div>
