			...
			<div className={styles.container}>
				<div className={styles.topContainer}>
					...
					<h5 className={styles.subTitle}>
						Are You Ready To START EARNING MASSIVELY With No Stress
						At All?{' '}
					</h5>
					<div className={styles.mainBanner}>
						<div className={styles.left}>
							...
							<br />
							<Button
								icon={<Image src={RightArrowBlue} alt="" />}
								onClick={() => router.push('/signup')}
								className={`hidden md:block ${styles.getStarted}`}
								type="default"
						...
						<div className={styles.right}>
							...
							everyone who buys using your referral link.
							<br />
							<br />
					...
					<section className={styles.learnMore}>
						<h3 className={styles.title}>
							Let&apos;s Learn from Michael&apos;s Story
						</h3>
						<h5 className={styles.subtitle}>
							The amazing all-in-one tools that bring a winning
							customer experience
						</h5>
						...
						<div className={styles.subSectionV2}>
							...
							<div className={styles.right}>
								<div className={styles.card}>
									<Card
										backgroundColor={'greenBackground'}
										content={
											'He applied for the offers and his request was approved, he got his unique referral link for each product.<br/><br/>\
                            ...
                            He became A MULTI MILLIONAIRE In Naira!'
									...
									<Card
										backgroundColor={'blueBackground'}
										content={
											'He had a following on his Facebook, Instagram and Whatsapp status.<br/><br/>\
							...
							<div className={styles.left}>
								<div className={styles.card}>
									<Card
										backgroundColor={'blueBackground'}
										content={
											'Got a total of 2,000 people to buy at least one of the products using his affiliate link<br/></br/>\
				...
				<div className={styles.bottomContainer}>
					<section className={styles.yourTurn}>
						...
						<div className={styles.right}>
							<p className="hidden md:block">
								...
								<br /> without dropping a sweat!
								<br />
								<br />
								It&apos;s as simple as Sign Up, Get a Unique
								Link,
								<br /> Promote and EARN!
								<br />
								<br />
								...
								you
								<br /> market. And you earn a predetermined
								commission
								<br /> for every purchase made using your link.
								<br />
								<br />
								This is an opportunity you won&apos;t find
								anywhere!
								<br />
								<br />
								Start making MASSIVE income through this once-
								<br />
								in-a-lifetime stream of income.
							</p>
							<p className="block md:hidden">
								<span>
									NOW IT IS YOUR TURN TO MAKE MILLIONS
								</span>{' '}
								without dropping a sweat!
								<br />
								<br />
								It&apos;s as simple as Sign Up, Get a Unique
								Link, Promote and EARN!
								<br />
								<br />
								You can refer as many people as you want for as
								...
								<br />
								You get a unique referral link for every product
								you market. And you earn a predetermined
								commission for every purchase made using your
								link.
								<br />
								<br />
								This is an opportunity you won&apos;t find
								...
								<br />
								<br />
								Start making MASSIVE income through this
								once-in-a-lifetime stream of income.
							</p>
						</div>
					</section>
					<section className={styles.signUpSection}>
						...
						<Button
							bgColor="blue"
							icon={<Image src={RightArrowWhite} alt="" />}
							onClick={() => router.push('/signup')}
							text="Get Started Free"
							style={{minWidth: '150px', padding: '.8rem'}}
						/>
					</section>
				</div>
			</div>
