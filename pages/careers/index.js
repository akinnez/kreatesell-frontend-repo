...
const Benefits = [
	{
		...
		title: 'Bonuses',
		description:
			'We provide bonuses including team eat outs, birthday celebrations, end of the year hangouts, give aways and other team bonding activities.',
	},
	{
		Icon: <Image src={Box} alt="" width="60" />,
		title: 'Quality Health Insurance',
		description:
			'"Health is wealth." We care about the health of the team as good health leads to better overall performance.',
	},
	{
		Icon: <Image src={Bag} alt="" width="60" />,
		title: 'Access to Certification Training Materials',
		description:
			'We are growth oriented and make sure that skill gaps within the team are closed. We ensure that the team members are up to date in their area of expertise.',
	},
	{
		Icon: <Image src={Building} alt="" width="60" />,
		title: 'Conducive Work Environment',
		description:
			'We provide a work environment that is friendly, boosts creativity, promotes individuality, strengthens team work and increases overall productivity.',
	},
	{
		Icon: <Image src={FlexibleOffice} alt="" width="60" />,
		title: 'Flexible Office <br/> Time',
		description:
			'We provide work-life balance to ensure that the team is more productive and are not lacking behind in any area of life.',
	},
	{
		Icon: <Image src={Accommodation} alt="" width="60" />,
		title: 'Suitable Accommodation',
		description:
			'We ensure that team members are well taken care of and have a convenient place to rest and recharge after a day of great work.',
	},
];
...
const Careers = () => {
	...
	const fetcher = () =>
		axios
			.get(`${process.env.BASE_URL}admin/Open`)
			...
			jobs?.forEach((job) => {
				...
				if (found) {
					let index = allJobs.findIndex(
						(jobIdx) =>
							jobIdx.category?.trim() === job.category?.trim()
					);
				...
				<div className={styles.body}>
					<div className={styles.header}>
						...
						<p className={styles.mobileSubHeader}>
							Upload your Ebooks, Online Courses, Video Courses,
							Subscription plans, and Memberships in an online
							all-in-one platform for free and accept payment from
							anywhere in the world.
						</p>
						<Link href={'#departments'}>
							<a className={styles.jobOpeningsBtn}>
								See Job Openings
							</a>
						</Link>
					</div>
					<section className={styles.benefits}>
						...
						<p className={styles.benefitsSubtitle}>
							In addition to a competitive salary, here&apos;re a
							few resources we offer to
							<br /> help our team excel.
						</p>
				...
				<div className={styles.body2} id="departments">
					<section className={styles.openPositions}>
						...
						<div className={styles.departments}>
							{sortedJobs.length > 0 &&
								sortedJobs.map((sJb, idx) => (
									<div
										key={idx}
										className={styles.department}
									>
										<div
											className={styles.nameActionSection}
										>
											<PositionHeader
												title={sJb.category}
												roles={`${sJb.jobs.length} open roles`}
											/>
										</div>
										{Array.isArray(sJb.jobs) &&
											sJb.jobs.map((job, idx2) => (
												<PositionsCard
													key={job?.id}
													title={job?.title || ''}
													description={
