...
export default function Home() {
	...
	console.log('Is dev', process.env.isDev);
	// test push
	return (
			...
			<div className={styles.container}>
				<div className={styles.body}>
					<div className={styles.header}>
						<h1>
							Kreate. Upload. And Sell <br /> <ProductsSlide />{' '}
							<br />
							online under 7 minutes. For Free
						</h1>
						<p className={styles.subHeader}>
							Upload your Ebooks, Online Courses, Video Courses,
							Subscription plans, <br /> and Memberships in an
							online all-in-one platform for free and accept
							payment from anywhere <br /> in the world.
						</p>
				...
				<div className={styles.featuresSection}>
					<div className={styles.subHero}>
						...
						<p>
							It&apos;s an amazing all-in-one platform that brings
					...
					<div className={styles.automation}>
						...
						>
							...
							<p className={styles.automationSubTitle}>
								Explore diverse ways of putting out your content
								for your audience to access — digital download,
								one-time subscription and/or membership. Be in
								total control of how people acquire your digital
								products.
							</p>
					...
					<div
						className={`${styles.automation} ${styles.automationAlte}`}
					>
						<div
							className={`${styles.automationText} ${styles.Two}`}
						>
							<h3 className={styles.automationTitle}>
							...
							<div className={styles.automationSubTitle}>
								<p>
									1. Activate different local currencies of
									customers (NGN, USD, UGX, TZX etc.)
								</p>
								<p>
									2. Get paid in customers&#39; local currency
								</p>
								<p>
									3. Payouts are made into your local bank
					...
					<div className={styles.automation}>
						...
						>
							...
							<p className={styles.automationSubTitle}>
								All the sales processes are being handled for
								you <br /> so you can focus on your most
								important work.
							</p>
							<p className={styles.mobileAutomationSubTitle}>
								All the sales processes are being handled for
								you so you can focus on your most important
								work.
							</p>
				...
				<div className={styles.midSection}>
					<div className={styles.midSectionText}>
						...
						<div className={styles.midSectionMobileTitle}>
							Easiest, fastest, and safest way to sell your
							Digital Products Online
						</div>

						<p className={styles.midSectionSubTitle}>
							Kreate an account for free and sell your digital{' '}
							<br /> products online from home or anywhere.
						</p>
						<p className={styles.midSectionMobileSubTitle}>
							Kreate an account for free and sell your digital
							products online from home or anywhere.
						</p>
				...
				<div className={styles.subFooter}>
					...
					<p className={styles.subFooterText}>
						See what amazing people are saying about the uniqueness
						and effectiveness of Kreatesell.
					</p>
