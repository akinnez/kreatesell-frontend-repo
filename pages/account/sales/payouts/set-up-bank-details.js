						...
						<div className={styles.illustrations}>
							<div className={styles.illustration}>
								...
								<div className={styles.kreator__illustration}>
									<Image
										src={KreatorIllustration}
										alt="Kreator Illustration"
									/>
								</div>
							</div>
					...
					<Col {...breakPoints} md={{span: 14, order: 1}}>
						<Card className={styles.card__wrapper}>
							<div className={styles.header}>
								...
								<p>
									<Text>
										You receive payments from your sales as
										a Kreator or/and commissions as an
										Affiliate with the account details
										provided.
									</Text>
								</p>
							</div>
							...
							<div className={styles.content}>
								<p>
									<Text>
										Your settlements go directly to the
										assigned bank account, mobile money
										wallet or PayPal address.
									</Text>
								</p>
							</div>
			...
			{successModal && (
				...
				>
					<section className={styles.content}>
						...
						<p>
							<Text>
								Congratulations! You can now start seamlessly
								receiving your settlement as at when due.
							</Text>
						</p>
					</section>
				</SuccessModalBox>
