											...
											<div className="row">
												<div className="col-8">
													...
													<div className="grey-bg">
														<Radio
															value={
																values.product_visibility_status
															}
															content={1}
															label="Visible"
										...
										<div className={styles.form_container}>
											...
											<div className="row">
												<div className="col-8">
													...
													<p
														className={
															styles.form_desc_txt
														}
													>
														Enter a customised CTA
														only if you want to
											...
											<div className="row">
												<div className="col-8">
													...
													>
														By default, you set the
														price in your local
														currency and we
														automatically convert
														the amount to other
														currencies on your store
														page, but if you&#39;d
														like to set the fixed
														price for other
														currencies, e.g USD?,
														you can enable this
														option on your{' '}
											...
											<div className="row">
												<div className="col-6">
													...
													>
														For the coupon discount,
														you can set either the
														percentage or the fixed
														amount discount. If you
														want to create coupon
														for other products you
														can see more on coupon
														settings page.
													</p>
												</div>
											</div>
