        ...
        <>
            ...
            <div className={styles.container2}>
                ...
                <div className='flex items-center w-full mt-4'>
                    ...
                    <div className={`flex-1 justify-center w-full ${styles.membershipHeader}`}>
                        Manage Membership
                    </div>
                ...
                <div className='w-full flex justify-center items-center mt-6'>
                    <div className= {`bg-white ${styles.manageContainer}`}>
                        <h1 className={styles.manageContainerText}>New Membership Details</h1>
                        <p className={styles.membershipAmount}>NGN 5,000</p>

                        <p className={styles.frequency}>Billing frequency</p>

                        <input type='text' className={styles.frequencyInput} placeholder='weekly'/>
