          ...
          <div className={styles.deliverFeatures}>
            <div className={`${styles.majorFeatures} ${styles.alternate}`}>
              ...
              >
                ...
                <h6 className={styles.featureExcerpt}>
                  Customize how, where, when, and the market you want to sell
                  your products to. Delivery will be done faster and safer,
                  based on what you pre-set.
                </h6>
                <div className={styles.featureIcon}>
                  <Image
                    src={DeliverFeature}
          ...
          <div className={styles.manageFeatures}>
            <div className={styles.majorFeatures}>
              ...
              >
                ...
                <h6 className={styles.featureExcerpt}>
                  You are provided with a full functional toolbox that takes
                  care of the legal and administrative requirements. Concentrate
                  on creating content and making money.
                </h6>
                <div className={styles.featureIcon}>
            ...
            <div className={styles.majorFeatures}>
              ...
              >
                ...
                <h6 className={styles.featureExcerpt}>
                  ...
                  with super-effective tools to help you increase your
                  conversion and sell better.
                </h6>
                <div className={styles.featureIcon}>
            ...
            <div className={styles.majorFeatures}>
              ...
              >
                ...
                <h6 className={styles.featureExcerpt}>
                  ...
                  use. Manage your payout settings and get settled in a flash,
          ...
          <div className={styles.supportFeatures}>
            <div className={`${styles.majorFeatures} ${styles.reassign}`}>
              ...
              >
                ...
                <h6 className={styles.featureExcerpt}>
                  Kreatesell support is your partner in business. We care for
                  your wellbeing and peace. That is why we&apos;re right next to
