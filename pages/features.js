			...
			<div className={styles.container} id="main-top">
				<div className={styles.hero}>
					...
					<h2 className={styles.mobileTitle}>
						No more headaches from <br /> multiple complex tech
						tools
					</h2>

					<p className={styles.webSubtitle}>
						You need quality time to create brilliant content for
						your audience who needs them. Upload your content on a
						simple
						<br /> all-in-one platform and save yourself from losing
						your peace in figuring things out….
					</p>
					<p className={styles.mobileSubtitle}>
						You need quality time to create brilliant content for
						your audience who needs them. Upload your content on a
						simple all-in-one platform and save yourself from losing
						your peace in figuring things out….
					</p>
				...
				<section className={styles.featuresContMain}>
					{/* Sell Features Row */}
						...
						<div className={styles.majorFeatures}>
							...
							>
								...
								<h6 className={styles.featureExcerpt}>
									Sell your contents to anywhere in the world
					...
					<div className={styles.deliverFeatures}>
						<div
							className={`${styles.majorFeatures} ${styles.alternate}`}
						>
							<div
								className={styles.mobileFeatureIcon}
								{...Animate('fade-right', 200, 'ease')}
							...
							<div className={styles.cardCont}>
								<div
									className={`${styles.firstRow} ${styles.alternateFirstRow}`}
								>
									<FeatureCard
										// animate={() => Animate("zoom-in", 100, "ease")}
							...
							>
								...
								<h6 className={styles.featureExcerpt}>
									Customize how, where, when, and the market
									you want to sell your products to. Delivery
									will be done faster and safer, based on what
									you pre-set.
								</h6>
								<div className={styles.featureIcon}>
									<Image
					...
					<div className={styles.manageFeatures}>
						<div className={styles.majorFeatures}>
							...
							>
								...
								<h6 className={styles.featureExcerpt}>
									You are provided with a full functional
									toolbox that takes care of the legal and
									administrative requirements. Concentrate on
					...
					<div className={styles.marketFeatures}>
						<div className={styles.majorFeatures}>
							...
							>
								...
								<h6 className={styles.featureExcerpt}>
									Reduce your stress by automating your
									marketing funnel or flow with
									super-effective tools to help you increase
									your conversion and sell better.
								</h6>
								<div className={styles.featureIcon}>
									<Image
										src={MarketFeatures}
...
"
					...
					<div className={styles.customizeFeatures}>
						<div
							className={`${styles.majorFeatures} ${styles.reassign}`}
						>
							<div
								className={styles.mobileFeatureIcon}
							...
							>
								...
								<h6 className={styles.featureExcerpt}>
									Make the checkout page to look just exactly
									as you want. Also, to bring ease to your
									target audience purchasing experience.
								</h6>
								<div className={styles.featureIcon}>
									<Image
										src={CustomizeFeatures}
										alt="feature icon"
									/>
								</div>
							</div>
					...
					<div className={styles.secureFeatures}>
						<div className={styles.majorFeatures}>
							...
							>
								...
								<h6 className={styles.featureExcerpt}>
									Get your personal documents and files
									secured by using the management tools on the
									platform.
								</h6>
								<div
					...
					<div className={styles.customizeFeatures}>
						...
						>
							...
							>
								...
								<h6 className={styles.featureExcerpt}>
									Get the proper data and analytics of your
									store with the comprehensive analytic tools
									provided by kreatsell.
								</h6>
								<div className={styles.featureIcon}>
									<Image
										src={AnalyzeFeature}
					...
					<div className={styles.secureFeatures}>
						<div className={styles.majorFeatures}>
							...
							>
								...
								<h6 className={styles.featureExcerpt}>
									Fast instant payment. With Kreatesell, your
									earnings are instantly sent to your local
									bank/wallet for easy access and use. Manage
									your payout settings and get settled in a
									flash, all from your dashboard.
								</h6>
								<div className={styles.featureIcon}>
									<Image
										src={PayoutFeatures}
...
const GenerateScrollLinks = ({data, handleClick, activeLink}) => {
	return data.map((item) => {
		...
		return (
			<li
				key={item}
				className={`${styles.scrollListItem} ${classApplied}`}
			>
				<Link
					to={item}
					spy={true}
