...
const Checkout = () => {
	...
	console.log(pricingTypeDetails?.price_type === 'Fixed Price', 'pricingTypeDetailspricingTypeDetails')

	// const standardPrice = desiredAmount
	// 	? desiredAmount
	// 	: getCurrency('minimum');

	const standardPrice = pricingTypeDetails?.price_type === 'Pay What You Want' ? desiredAmount
		? desiredAmount
		: getCurrency('minimum') : Number(getCurrency('price')).toFixed(2)
