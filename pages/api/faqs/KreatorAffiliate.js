export const questions = [
    {
        ...
        answer: `On Kreatesell, we provide payout and settlement at due intervals of 24 hours to 10 days depending on your currency and country. Check out your wait time here.

        If payment is not received by the set date, you can report the issue to us at payment@kreatesell.com
        `
    },
    {
    ...
    },
    {
        ...
        answer: `Yes, Kreatesell provides maximum security on our website. So, your login information is safe on the site. All passwords entered into our website are encrypted so, they are not visible to anyone, including us. We also have the option for you to activate Two Factor Authentication (2FA). If you have issues with logging in to your account, send us an email at business@kreatesell.com with your registered email address.
        `
    },
    {
