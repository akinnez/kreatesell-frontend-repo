			...
			<div className={styles.container}>
				<div className={styles.hero}>
					...
					<p className={styles.subtitle}>
						A smarter and better way of making money from your
						content.
					</p>
				...
				<div className={styles.bestOption}>
					...
					>
						...
						<p className={styles.pillContent}>
							KreateSell is an ease-to-use, cross-border ecommerce{' '}
							<br /> platform that will enable you to upload your
							digital products for <br />
							fastest and easiest sales and conversion without
							having to <br /> learn multiple complex sales funnel
							platforms. And you instantly get <br />
							paid from anywhere in the world conveniently.
						</p>
						<p className={styles.mobilePillContent}>
							KreateSell is an ease-to-use, cross-border ecommerce
							platform that will enable you to upload your digital
							products for the fastest and easiest sales and
							conversions, without having to learn to use multiple
							complex sales funnel platforms. And you instantly
							get paid from anywhere in the world conveniently.
						</p>
					</div>
					<div
				...
				<div className={styles.subCaption}>
					...
					<p {...Animate('fade-up', 600, 'ease')}>
						Amazing all-in-one tools that bring a winning customer
						experience
					</p>
				</div>
						...
						>
							...
							<div className={styles.statementBox}>
								<p className={styles.statement}>
									To get started, just navigate to the get
									started or sign up button and create a free
									account to have the all-in-one system in
									action for your use.
								</p>
								<br />
								<p className={styles.statement}>
									Getting set? Add all your store details for
									easy recognition. Use details that compel,
									attract and intrigue potential buyers.
								</p>
				...
				<div className={`${styles.rowOne} ${styles.evenRow}`}>
					<div className={styles.rowContent}>
						...
						>
							...
							<div className={styles.statementBox}>
								<p className={styles.statement}>
									Ready to go global? Create your products
									with awesome descriptions and additional
									beneficial details that capture the
									attention of customers. After that, share
									your product link to your target audience.
								</p>
							</div>
						</div>
					</div>
				...
				<div className={`${styles.rowOne} ${styles.rowThree}`}>
					...
					<div className={styles.rowContent}>
						...
						>
							...
							<div className={styles.statementBox}>
								<p className={styles.statement}>
									Creating any of the supported products -
									membership, subscription or digital
									downloads under minutes is cool, right?
								</p>
								{/* here */}
								<p className={styles.statement}>
									The cooler part of it is setting up your
									funnel on the same page in a couple of
									clicks, without going through any tech
									headache. Do that and you are ready to go
									live and start getting paid from anywhere in
									the world where your audience reside, in
									seconds.
								</p>
								{/* here */}
								<p className={styles.statement}>
									Click the publish button and your product
									link will be available for sharing.
								</p>
							</div>
						</div>
					</div>
				...
				<div className={`${styles.rowOne} ${styles.evenRow}`}>
					<div className={styles.rowContent}>
						...
						>
							...
							<div className={styles.statementBox}>
								<p className={styles.statement}>
									Enter your local bank account details and
									start receiving your sales payment
									instantly. No more foreign currency
									barriers, you&apos;ll receive your payout
									directly and instantly into the account
									provided.
								</p>
							</div>
						</div>
	...
	return (
		<div className={styles.subFooter}>
			...
			<h3
				...
				// {...Animate("fade-up", 200, "ease")}
			>
				KreateSell solves your marketing and conversion hectic
				processes.
			</h3>
			<p>
				Rid yourself of stress. Upload more content. Make money. Enjoy
				your choiced life to the fullest.
			</p>
			<Button
