						...
						<div className={styles.chargeBackCarouselContainer}>
							...
							<div className={styles.chargeBackWrapper}>
								<section className={styles.cashbackTopSection}>
									...
									<div className={styles.chargePendingDiv}>
										{' '}
										Pending
									</div>
								</section>
								<section
									className={styles.cashbackReasonSection}
								>
									<h4
										className={
											styles.chargeBackReasonHeading
										}
									>
										Chargeback Reason
									</h4>
								...
								<section className={styles.logDateSection}>
									...
									<p className={styles.warning}>
										You have just 10hrs to accept or decline
										this chargeback or it will be processed
										automatically
									</p>
								</section>
