        ...
        <Col span={12}>
          <Card className={style.bank_card}>
            ...
            <p className={style.subtitle}>
              How do you want to be receiving your payment?
            </p>
            <Form>
              <Space direction="vertical">
                ...
                <p className={style.sch_desc}>
                  Your funds will be automatically withdrawn into the provided
                  bank account.
                </p>
                <Radio
                  name="name"
                ...
                <p className={style.sch_desc}>
                  By choosing this option, you&#39;ll have to be manually
                  withdrawing your funds to the provided bank account.
                </p>
                <Button
                  disabled
        ...
        <Col span={12}>
          <Card className={style.bank_card}>
            ...
            <Button
              ...
              label="Change payout account settings"
            />
          </Card>
        </Col>
      </Row>
