				...
				<section>
					{bankDetails ? (
						<div className={styles.bank__details}>
							<p>
								<Text>
									We pay the money made from your sales into
									this account.
								</Text>
							</p>
							...
							{editModal && (
								<EditBankDetails
									editModal={editModal}
									hideEditModal={handleClicks(
										setEditModal,
										false
									)}
									bankDetails={bankDetails}
									showSuccessModal={handleClicks(
										setSuccessModal,
										true
									)}
								/>
									...
									<section className={styles.content}>
										...
										<p>
											<Text>
												...
												start seamlessly receiving your
												settlement in your new account
												as at when due.
											</Text>
										</p>
									</section>
						...
						<div className={styles.no__bank__details}>
							...
							<p>
								<Text>
									To start receiving money from your sales
									ensure you setup your bank details
								</Text>
							</p>
