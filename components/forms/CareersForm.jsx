			...
			>
				...
				<TextAreaWithExtraLabel
					...
					rules={[
						{
							required: true,
							message: 'Please list your personality gems',
						},
					]}
				/>
				<TextAreaWithExtraLabel
				...
				<DropzoneV2
					...
					// accept=""
					label={
						'Optional: Upload a 1-minute audio or video describing why you think you will be a good fit for this role!'
					}
				/>
				...
				<div className={styles.checkbox}>
					<Checkbox
						name="rememberMe"
						onChange={() => setAllowConsent((prev) => !prev)}
					/>
					<p className={styles.checkboxText}>
						KreateSell has my consent to collect, store, and process
						my data for the purpose of considering me for employment
					</p>
				</div>
