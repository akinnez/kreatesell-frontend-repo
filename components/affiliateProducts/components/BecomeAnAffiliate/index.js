			...
			>
				<div className={styles.modal__content}>
					<header className={styles.header}>
						<Text strong>
							To access the products in the marketplace, you have
							to click the button below to become an affiliate.
						</Text>
					</header>
					<section className={styles.content}>
						<p>
							<Text>
								Ensure that you have read and agree to the terms
								and conditions of becoming an affiliate before
								proceeding.
							</Text>
						</p>
						<div>
