		...
		<>
			...
			>
				<Link href={isDropDown ? "#" : target}>
					<a>
						<div
							className={`nav-menu-icon-wrapper ${active ? "active" : null}`}
						>
							<div
								className={`menu-icon ${active ? "opaque" : null}`}
								style={iconStyle}
							>
								<Icon
									set="bulk"
			...
			<style jsx>{`
				...
				li a .nav-menu-icon-wrapper:hover,
				.active {
						...
						<li style={{ marginTop: "50px" }}>
							<div className="card-bg">
								<div className="overlay">
									...
									<Link href="#">
										<a className="btn-link">GO PRO PLAN</a>
									</Link>
								</div>
							</div>
						</li>
			...
			<style jsx>{`
				...
				.card-bg .overlay {
					background: linear-gradient(
						163.16deg,
						rgba(0, 102, 255, 0.5) 10.04%,
						rgba(0, 147, 53, 0.5) 101.52%
					);
					position: absolute;
					top: 0;
					left: 0;
