...
const SneakPeak = ({ setShowModal }) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <motion.p className={styles.peak_text}>Quickly join the early birds to enjoy all these for FREE from when KreateSell launches! Time is running out and people are joining fast! Don’t be left out of this mouth-watering offer.</motion.p>
