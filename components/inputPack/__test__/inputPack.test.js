...
describe('Button : ', () => {
	...
	it('renders a snapshot of <Button /> when the loading prop is true and disabled prop is false', () => {
		const btn = renderer
			.create(
				<Button onClick={handleClick} disabled={false} loading={true} />
			)
			.toJSON();
		expect(btn).toMatchSnapshot();
	});
	it('renders a snapshot of <Button /> when the loading prop is true and disabled prop is false', () => {
		const btn = renderer
			.create(
				<Button onClick={handleClick} disabled={true} loading={false} />
			)
			.toJSON();
		expect(btn).toMatchSnapshot();
	});
	it('renders a snapshot of <Button /> when the loading prop is true and disabled prop is false', () => {
		const btn = renderer
			.create(
				<Button onClick={handleClick} disabled={true} loading={true} />
			)
			.toJSON();
		expect(btn).toMatchSnapshot();
	});
...
describe('Switch : ', () => {
	it('renders a snapshot of <Switch /> with mock props', () => {
		const _switch = renderer
			.create(
				<Switch value={value} onChange={handleChange} label={label} />
			)
			.toJSON();
...
describe('Percentage : ', () => {
	it('renders a snapshot of <Percentage /> with mock props', () => {
		const percentage = renderer
			.create(
				<Percentage value={value} onChange={handleChange} name={name} />
			)
			.toJSON();
