	...
	>
		<Col {...breakpoints}>
			<Card className={styles.card__wrapper}>
				<div className={styles.stats__content}>
					<div
						className={`${styles.image__wrapper} ${styles.recovery__img}`}
					>
		...
		<Col {...breakpoints}>
			<Card className={styles.card__wrapper}>
				<div className={styles.stats__content}>
					<div
						className={`${styles.image__wrapper} ${styles.abandoned__img}`}
					>
						<div className={styles.image}>
		...
		<Col {...breakpoints}>
			<Card className={styles.card__wrapper}>
				<div className={styles.stats__content}>
					<div
						className={`${styles.image__wrapper} ${styles.recovered__img}`}
					>
						<div className={styles.image}>
							<Image src={BasketImg} alt="Basket Icon" />
						</div>
