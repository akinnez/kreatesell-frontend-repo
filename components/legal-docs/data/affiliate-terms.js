	...
	data: [
		{
            ...
            to the Affiliate Link or the cookies.`,
				...
				`Affiliate commissions will be paid into local bank account only when the Affiliate has at least minimum
                of #5000 or $20 balance ripped for withdrawal.`,
				'',

				`Affiliate Fees and Payouts`,
				`A affiliate promoter will become eligible for payout after the successful 
            sale of a product if it meets all of these criteria:`,
				`The referred customer has paid in full for the 
            purchase of a new premium subscription plan.`,
				`The affiliate promoter’s account remains 
            active and in having good stats.`,
				`The affiliate promoter’s account hasn’t had any of his / or
        ...
        as otherwise determined by KreateSell in its sole discretion.`,
				...
				`So, basically affiliates must have a minimum of 5 sales before he / or she can be automatically qualified 
		...
		{
			question: 'AFFILIATE COOKIES POLICY',
			answer: [
				`Affiliate Link Visitor cookie is generated and saved on the device of every single customer that clicks the unique Referral link of the promoters, however the customer / or visitor will only be mapped to an affiliate promoter if the potential 
        customer was referred by an affiliate. Otherwise, no affiliate promoter will earn commission from such customers.`,
			],
		},
		{
			question: 'COOKIE LIFETIME',
			answer: [
				`
            An Affiliate Referral links cookie validity period is set to be 12 full months for active promoters of the platform. 
            The cookie is valid and present in the customer's browser/computer within a period of 12 months of clicking
             the affiliate referral link, the customer does not need to go through the affiliate's link again 
             if he makes a purchase in the future. He / or she just needs to visit the Kreator's or the merchant's shop,
            make a purchase and the affiliate who brought him / or her will be rewarded. 
        ...
        to the last affiliate link clicked by a prospect or customer of a product.`,
				...
				`If a customer(Buyer) clicks PROMOTER A's Affiliate link but doesn't purchase anything
            and two days later, the customer(Buyers) then clicks PROMOTER B's Affiliate and then makes a 
            successful purchase of the product, the last Affiliate Promoter link(PROMOTER B) clicked will
            overwrite the cookie of the initial Affiliate Promoter(PROMOTER A) link cookies and the sales
            commission will go to PROMOTER B and PROMOTER B will be getting commissions for any valid purchases
            made by the customer(Buyer) until that same customer(Buyer) clicks on another promoter’s affiliate
            link.If the buyer doesn’t click another affiliate promoter link, the former cookie validity is 12
