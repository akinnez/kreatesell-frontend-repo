  ...
  return (
    ...
    <Row gutter={20} align="bottom" justify="center">
        ...
        <Form.Item label="Search" name="search">
            <Input prefix={<MdSearch />} placeholder="Click here to Search" onChange={handleSearch} />
        </Form.Item>
        </Col>
        <Col
            xs={{ span: 24 }}
        ...
        <Form.Item label="Show" name="show">
            ...
            options={JobType}
            placeholder="Today"
            onChange={(value)=>handleDropdown(value, "show")}
            />
        </Form.Item>
        </Col>
        <Col
        ...
        <Form.Item label="Currency" name="currency">
            ...
            options={JobType}
            placeholder="NGN"
            onChange={(value)=>handleDropdown(value, "currency")}
            />
        </Form.Item>
        </Col>
        <Col
