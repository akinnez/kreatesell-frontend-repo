		...
		<>
			<div className={styles.container}>
				...
				<p className={styles.subTitle}>
					Note that this page is reserved for a 2nd tier settings and
					you will be required to complete your KYC to activate the
					process.{' '}
				</p>
				<section className={styles.paymentIntegration}>
					<div className={styles.left}>
						...
						<p className={styles.subTitle}>
							You have to provide the credentials requested below
							to activate these payment methods to offer checkout
							options that best suits you and your clients
						</p>
						...
						{store?.kyc_status?.kyc_status === 'Denied' && (
							<>
								<h3 className={styles.reasonsHeader}>
									Reasons for rejecting second level
									verification
								</h3>
